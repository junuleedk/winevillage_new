...
<div class="lnb comm_lnb bg_lnb community_lnb lnb_wrap">
	...
	<div class="pc_lnb mb_hidden">
		...
		<ul class="menu tab3">
			...
			<li class="on"><a href="/shop/community/magazine_con_lists.do"><span>Our Stories</span></a></li>
...
<div class="wrap">
	<div class="content community magazine_con_lists_page">
		<div class="inner">
			<!-- <div class="view_top">
                <div class="img">		
                    <picture> -->
				...
				<li>
					<a href="/shop/community/magazine_con_view.do?seq=${item.seq}">
						<div class="img">
							<picture>
							<!--[if IE 9]><video style="display: none;"><![endif]-->
							<source srcset="/../../uploads/magazine_con/${item.thumbnail}" media="(min-width:768px)">
							<!-- pc이미지 -->
							<source srcset="/../../uploads/magazine_con/${item.thumbnail}" media="(max-width:767px)">
							<!-- mb이미지 -->
							<!--[if IE 9]></video><![endif]-->
							<img src="/../../uploads/magazine_con/${item.thumbnail}" alt="magazine1">
							<!-- pc이미지 -->
							</picture>
						</div>
						<div class="text">
							<span class="sub_tit">${item.series}</span>
							<strong class="tit">${item.title}</strong>
							<!-- <span class="txt"><p style="text-align: center; " align="center"> </p><p style="text-align: cen...</span> -->
						</div>
					</a>
				</li>
				</c:forEach>
...
<form action="<c:url value='/shop/community/magazine_con_lists.do' />" id="ListForm" name="ListForm" method="post" accept-charset="utf-8">
...
function getList(mode){
    ...
    $.ajax({
        type: "POST",
        url : "/shop/community/magazine_con_lists_ajax",
