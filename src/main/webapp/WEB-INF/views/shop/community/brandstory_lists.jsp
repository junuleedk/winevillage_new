	...
	<div class="content community brandstory_lists_page">
		<div class="inner">
			<ul class="brandstory_lists" id="brandstory_ul">
				...
				<li>
					<a href="/shop/community/brandstory_view?story_seq=${item.story_seq}">
						<div class="img">
							<picture>
...
<form action="<c:url value='/shop/community/brandstory_lists' />" id="ListForm" name="ListForm" method="post" accept-charset="utf-8">
