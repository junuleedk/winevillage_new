...
<html lang="ko">
<head>
<title>WINEVILLAGE 2024 ㅣ 이용약관</title>
...
<div class="lnb member_lnb lnb_wrap">
	<div class="pc_hidden">
		...
		<div class="select_brand js_select" id="select_brand">
			<button type="button" class="my_value js_selectBtn" onclick="$(this).toggleClass('on')"><span>이용약관</span></button>
	...
	<div class="pc_lnb mb_hidden">
		<div class="page_tit">
			<h2><span>이용약관</span></h2>
		</div>
	</div>
</div>
<div class="wrap">
	<div class="content member policy law_con_page">
		<div class="policy_wrap">
			<ul class="policy_lists">
				<li class="on">
					<button class="tit"><span>제1조(목적)</span></button>
					<div class="con_wrap">
						<div class="con">
							 이 약관은 ㈜와인나라아이비 제일와인셀러점 회사(전자거래 사업자)가 운영하는 ㈜와인나라아이비 제일와인셀러점 쇼핑몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 쇼핑몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.<br>
							 ※ 「PC통신 등을 이용하는 전자거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」<br>
						</div>
					</div>
				</li>
				<li>
					<button class="tit"><span>제2조(정의)</span></button>
					<div class="con_wrap">
						<div class="con">
							 ① "몰"이란 ㈜와인나라아이비 제일와인셀러점 회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.<br>
				...
				<li>
					<button class="tit"><span>제3조(약관 등의 명시와 설명 및 개정)</span></button>
					<div class="con_wrap">
						<div class="con">
							 ① "몰"은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호·모사전송번호·전자우편주소, 사업자등록번호, 통신판매업신고번호, 개인정보관리책임자 등을 이용자가 쉽게 알 수 있도록 "몰"의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.<br>
							 ...
							 ③ "몰"은 전자상거래 등에서의 소비자보호에 관한 법률, 약관의 규제에 관한 법률, 전자거래기본법, 전자서명법, 정보통신망 이용촉진 등에 관한 법률, 방문판매 등에 관한 법률, 소비자보호법 등 관련법을 위배하지 않는 범위에서 이 약관을 개정할 수 있습니다.<br>
							 ...
							 ⑤ "몰"이 약관을 개정할 경우에는 그 개정약관은 그 적용일자 이후에 체결되는 계약에만 적용되고 그 이전에 이미 체결된 계약에 대해서는 개정전의 약관조항이 그대로 적용됩니다. 다만 이미 계약을 체결한 이용자가 개정약관 조항의 적용을 받기를 원하는 뜻을 제3항에 의한 개정약관의 공지기간 내에 "몰"에 송신하여 "몰"의 동의를 받은 경우에는 개정약관 조항이 적용됩니다.<br>
				...
				<li>
					<button class="tit"><span>제4조(서비스의 제공 및 변경)</span></button>
					<div class="con_wrap">
						<div class="con">
				...
				<li>
					<button class="tit"><span>제5조(서비스의 중단)</span></button>
					<div class="con_wrap">
						<div class="con">
				...
				<li>
					<button class="tit"><span>제6조(회원가입)</span></button>
					<div class="con_wrap">
						<div class="con">
				...
				<li>
					<button class="tit"><span>제7조(회원 탈퇴 및 자격 상실 등)</span></button>
					<div class="con_wrap">
						<div class="con">
							 ...
							 ⑤ 회원 탈퇴 시 기존 적립금은 소멸합니다.<br>
						</div>
					</div>
				</li>
				<li>
					<button class="tit"><span>제8조(회원에 대한 통지)</span></button>
					<div class="con_wrap">
						<div class="con">
							 ① "몰"이 회원에 대한 통지를 하는 경우, 회원이 "몰"과 미리 약정하여 지정한 전자우편 주소로 할 수 있습니다.<br>
							 ② "몰"은 불특정다수 회원에 대한 통지의 경우 1주일이상 "몰" 게시판에 게시함으로써 개별 통지에 갈음할 수 있습니다. 다만, 회원 본인의 거래와 관련하여 중대한 영향을 미치는 사항에 대하여는 개별통지를 합니다.<br>
						</div>
					</div>
				</li>
				<li>
					<button class="tit"><span>제9조(구매신청)</span></button>
					<div class="con_wrap">
						<div class="con">
				...
				<li>
					<button class="tit"><span>제10조 결제방법의 선택(적립금 제도 운영)</span></button>
					<div class="con_wrap">
						<div class="con">
							 ① 적립금은 "몰" 내에서 현금처럼 사용할 수 있는 전자 화폐입니다.<br>
							 ② "몰" 회원으로 가입하시고, 적립금 지급 상품을 구입하실 경우, 운영정책에 따라 상품 별로 정해진 적립금을 드립니다.<br>
							 ③ 적립금은 "몰"에서 상품을 구매하실 경우 금액과 상관없이 현금과 동일하게 사용하실 수 있으나, 현금으로 교환할 수 없습니다.<br>
							 ④ 회원 탈퇴 시 기존 적립금은 소멸합니다.<br>
							 ⑤ 회원은 적립금 부여일로부터 12개월 이내에 해당 적립금을 사용하여야 합니다. 적립금은 부여된 순서에 따라 사용되며, 부여일로부터 12개월 이후에도 사용되지 않은 적립금은 자동 소멸됩니다.<br>
							 ⑥ 적립금을 이용하여 부당 이득을 취하거나, 악의적인 상거래가 발생할 경우, ㈜와인나라아이비 제일와인셀러점 쇼핑몰은 해당 적립금의 지급을 중지 또는 회입할 수 있습니다.<br>
							 ⑦ ㈜와인나라아이비 제일와인셀러점 오프라인 직영 와인나라 매장과 ㈜와인나라아이비 제일와인셀러점 운영 "몰"의 적립금 함께 관리되며, 함께 사용할 수 있습니다.<br>
						</div>
					</div>
				</li>
				<li>
					<button class="tit"><span>제11조(계약의 성립)</span></button>
					<div class="con_wrap">
						<div class="con">
				...
				<li>
					<button class="tit"><span>제12조(지급방법)</span></button>
					<div class="con_wrap">
						<div class="con">
				...
				<li>
					<button class="tit"><span>제13조(수신확인통지·구매신청 변경 및 취소)</span></button>
					<div class="con_wrap">
						<div class="con">
							 ① "몰"은 이용자의 구매신청이 있는 경우 이용자에게 수신확인통지를 합니다.<br>
							 ② 수신확인통지를 받은 이용자는 의사표시의 불일치 등이 있는 경우에는 수신확인통지를 받은 후 즉시 구매신청 변경 및 취소를 요청할 수 있고 "몰"은 배송 전에 이용자의 요청이 있는 경우에는 지체없이 그 요청에 따라 처리하여야 합니다. 다만 이미 대금을 지불한 경우에는 제15조의 청약철회 등에 관한 규정에 따릅니다.<br>
						</div>
					</div>
				</li>
				<li>
					<button class="tit"><span>제14조(재화 등의 공급)</span></button>
					<div class="con_wrap">
						<div class="con">
				...
				<li>
					<button class="tit"><span>제15조(환급)</span></button>
					<div class="con_wrap">
						<div class="con">
							 "몰"은 이용자가 구매 신청한 재화 등이 품절 등의 사유로 인도 또는 제공을 할 수 없을 때에는 지체없이 그 사유를 이용자에게 통지하고 사전에 재화 등의 대금을 받은 경우에는 대금을 받은 날부터 2영업일 이내에 환급하거나 환급에 필요한 조치를 취합니다.<br>
						</div>
					</div>
				</li>
				<li>
					<button class="tit"><span>제16조(청약철회 등)</span></button>
					<div class="con_wrap">
						<div class="con">
							 ...
							 ④ 이용자는 제1항 및 제2항의 규정에 불구하고 재화 등의 내용이 표시·광고 내용과 다르거나 계약내용과 다르게 이행된 때에는 당해 재화 등을 공급받은 날부터 3개월 이내, 그 사실을 안 날 또는 알 수 있었던 날부터 30일 이내에 청약철회 등을 할 수 있습니다.<br>
						</div>
					</div>
				</li>
				<li>
					<button class="tit"><span>제17조(청약철회 등의 효과)</span></button>
					<div class="con_wrap">
						<div class="con">
							 ① "몰"은 이용자로부터 재화 등을 반환 받은 경우 3영업일 이내에 이미 지급받은 재화 등의 대금을 환급합니다. 이 경우 "몰"이 이용자에게 재화 등의 환급을 지연한 때에는 그 지연기간에 대하여 공정거래위원회가 정하여 고시하는 지연이자율을 곱하여 산정한 지연이자를 지급합니다.<br>
							 ② "몰"은 위 대금을 환급함에 있어서 이용자가 신용카드 또는 전자화폐 등의 결제수단으로 재화 등의 대금을 지급한 때에는 지체없이 당해 결제수단을 제공한 사업자로 하여금 재화 등의 대금의 청구를 정지 또는 취소하도록 요청합니다.<br>
				...
				<li>
					<button class="tit"><span>제18조(개인정보보호)</span></button>
					<div class="con_wrap">
						<div class="con">
							 ...
							 ③ 제공된 개인정보는 당해 이용자의 동의없이 목적 외의 이용이나 제3자에게 제공할 수 없으며, 이에 대한 모든 책임은 몰이 집니다. 다만, 다음의 경우에는 예외로 합니다.<br>
				...
				<li>
					<button class="tit"><span>제19조(“몰“의 의무)</span></button>
					<div class="con_wrap">
						<div class="con">
				...
				<li>
					<button class="tit"><span>제20조(회원의 ID 및 비밀번호에 대한 의무)</span></button>
					<div class="con_wrap">
						<div class="con">
				...
				<li>
					<button class="tit"><span>제21조(이용자의 의무)</span></button>
					<div class="con_wrap">
						<div class="con">
				...
				<li>
					<button class="tit"><span>제22조(연결"몰"과 피연결"몰" 간의 관계)</span></button>
					<div class="con_wrap">
						<div class="con">
							 ① 상위 "몰"과 하위 "몰"이 하이퍼 링크(예: 하이퍼 링크의 대상에는 문자, 그림 및 동화상 등이 포함됨)방식 등으로 연결된 경우, 전자를 연결 "몰"(웹 사이트)이라고 하고 후자를 피연결 "몰"(웹사이트)이라고 합니다.<br>
							 ② 연결"몰"은 피연결"몰"이 독자적으로 제공하는 재화 등에 의하여 이용자와 행하는 거래에 대해서 보증책임을 지지 않는다는 뜻을 연결"몰"의 초기화면 또는 연결되는 시점의 팝업화면으로 명시한 경우에는 그 거래에 대한 보증책임을 지지 않습니다.<br>
						</div>
					</div>
				</li>
				<li>
					<button class="tit"><span>제23조(저작권의 귀속 및 이용제한)</span></button>
					<div class="con_wrap">
						<div class="con">
				...
				<li>
					<button class="tit"><span>제24조(분쟁해결)</span></button>
					<div class="con_wrap">
						<div class="con">
				...
				<li>
					<button class="tit"><span>제25조(재판권 및 준거법)</span></button>
					<div class="con_wrap">
						<div class="con">
							 ① "몰"과 이용자간에 발생한 전자상거래 분쟁에 관한 소송은 서울중앙지방법원의 전속관할로 합니다.<br>
							 ② "몰"과 이용자간에 제기된 전자상거래 소송에는 대한민국 법령을 적용합니다.<br>
						</div>
					</div>
				</li>
				<li>
					<button class="tit"><span>부칙</span></button>
					<div class="con_wrap">
						<div class="con">
