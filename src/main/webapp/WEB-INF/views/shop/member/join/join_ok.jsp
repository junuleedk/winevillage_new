		...
		<div class="inner">
			<div class="ok_area">
				...
				<div class="btn_area col2">
					...
					<button type="button" class="btn_txt btn_black" onclick="location.href='/shop/product/product_lists.do?category=10000'" style="float:none;display:inline-block;">쇼핑하러가기</button>
				</div>
			</div>
		</div>
	</div>
