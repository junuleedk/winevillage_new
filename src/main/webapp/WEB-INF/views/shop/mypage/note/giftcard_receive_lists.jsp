...
<div class="content mypage note giftcard_page giftcard_receive_lists_page top_gap">
	<div class="inner">
		<div class="top_info">
			<div class="page_tit">
		...
		<div class="tab_area my_gift">
			<ul class="js_tabBtn tab3">
				...
				<li class="on"><button type="button" onclick="location.href='/shop/mypage/note/giftcard_receive_lists'"><span>받은 기프트카드</span></button></li>
			</ul>
