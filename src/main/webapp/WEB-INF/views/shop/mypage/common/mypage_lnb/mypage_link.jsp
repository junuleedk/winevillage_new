...
<div class="mypage_link mb_hidden">
	<ul class="depth_01">
		<li>
			...
			<ul class="depth_02">
				<li><a href="/shop/mypage/shopping/order_lists.do">주문내역</a></li>
				<!-- <li><a href="/shop/mypage/shopping/return_order_lists">교환/반품내역</a></li> -->
				<li<c:if test="${mypage_lnb == 'wish_lists'}"> class="on"</c:if>><a href="/shop/mypage/note/wish_lists.do">위시리스트</a></li>
		...
		<li>
			<a href="#none">쇼핑수첩</a>
			<ul class="depth_02">
				<li><a href="/shop/mypage/note/giftcard_lists.do">나의 기프트카드</a></li>
				<!-- <li ><a href="/shop/mypage/note/balance_lists">나의 예치금</a></li> -->
				<li<c:if test="${mypage_lnb == 'mileage_lists'}"> class="on"</c:if>><a href="/shop/mypage/note/mileage_lists.do">나의 마일리지</a></li>
				<li<c:if test="${mypage_lnb == 'coupon_lists'}"> class="on"</c:if>><a href="/shop/mypage/note/coupon_lists.do">나의 쿠폰</a></li>
			</ul>
		</li>
		<!-- <li>
			<a href="#none">나의 활동</a>
