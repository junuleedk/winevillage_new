...
<div class="lnb mypage_lnb lnb_wrap">
	<div class="pc_hidden">
		...
		<div class="select_brand js_select" id="select_brand">
			<button type="button" class="my_value js_selectBtn" onclick="$(this).toggleClass('on')"><span>비밀번호 변경</span></button>
	...
	<div class="common_lnb">
		<div class="my">
			<div class="txt grade_area">
				<div class="img gold grade_info g">
					<span>실버</span>
				</div>
				<p>
		...
		<ul class="depth_01">
			...
			<li>
                ...
                <ul class="depth_02">
                    ...
                    <li><a href="/shop/mypage/account/password_cert">회원정보수정</a></li>
                    <li><a href="/shop/mypage/account/sns_connect">SNS 연동관리</a></li>
                    <li class="on"><a href="/shop/mypage/account/change_password">비밀번호 변경</a></li>
                    <li><a href="/shop/mypage/account/withdrawal">회원탈퇴</a></li>
                </ul>
			</li>
		</ul>
...
<div class="content mypage accont withdrawal_ok_page ok_page">
	<div class="inner">
		<div class="ok_area">
			<p class="tit">회원탈퇴가 완료되었습니다.</p>
			<p class="txt">
				 그동안 와인나라를 이용해주셔서 감사합니다. <br>
				보다 나은 서비스로 다시 찾아 뵙겠습니다.
			</p>
			<div class="btn_area">
				<a href="/shop/main" class="btn_txt">홈으로</a>
			</div>
		</div>
	</div>
</div>
